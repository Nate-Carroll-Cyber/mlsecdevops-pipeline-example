# Counter-Spy.ai v2.3: Adversary-Aware Prompt Firewall & Forwarding Gateway
...
- **Safeguard Effective Prompt Review**: System Configuration displays and hashes the recommended and current effective safeguard prompt text so intentional prompt updates can be reviewed as configuration artifacts. The current promoted recommended baseline hash and aligned current safeguard prompt hash are `78b54175e27126f42ae7f4204619170fd98a5422c5e77929e7822563ca8f9214`. The protected backend gateway accepts the allowlisted `safeguardEffectivePrompt` field and forwards it verbatim to the safeguard judge.
