...
- **Keyword & Topic Filtering**: Matches input against configurable lists of blocked phrases and forbidden topics. Includes a curated default blocklist for roleplay-based injections and risky transport markers such as `javascript:` and `://`, and redacts policy-triggering script/URL payloads before they are persisted in audit detail views.
